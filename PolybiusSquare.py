...
def decode_polybius_caesar(str):
    i = 0
    str_out = ''
...
print("*Шифрованный текст: ", *encode_polybius_caesar(), sep='')


str = "11254211132336"
print("Разшировка Квадрат Полибия")
print("*Открытый текст: ", str)
print("*Pазшифрованный текст : ", decode_polybius_caesar(str))
